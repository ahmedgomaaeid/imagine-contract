                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.admin.worker')}}"><i class="side-menu__icon fe fe-users"></i><span
                                        class="side-menu__label">المقاولين</span></a>
                            </li>
                            ...
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.admin.jop')}}"><i class="side-menu__icon fa fa-wpforms"></i><span
                                        class="side-menu__label">المهام الجديدة</span></a>
                            </li>
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.admin.jop.submited')}}"><i class="side-menu__icon fa fa-wpforms"></i><span
                                        class="side-menu__label">المهام الموزعة</span></a>
                            </li>
