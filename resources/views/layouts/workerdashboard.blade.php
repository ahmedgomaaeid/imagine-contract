                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.house1.create')}}"><i
                                        class="side-menu__icon fe fe-home"></i><span
                                        class="side-menu__label">ادخال منزل شعرة واحدة</span></a>
                            </li>
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.house4.create')}}"><i
                                        class="side-menu__icon fe fe-home"></i><span
                                        class="side-menu__label">ادخال منزل 4 شعرات</span></a>
                            </li>
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.build4.create')}}"><i
                                        class="side-menu__icon fe fe-home"></i><span
                                        class="side-menu__label">ادخال بناية 4 شعرات</span></a>
                            </li>
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.open-house.create')}}"><i
                                        class="side-menu__icon fe fe-home"></i><span
                                        class="side-menu__label">اعمال جانبية</span></a>
                            </li>
                            ...
                            <li>
                                <a class="side-menu__item has-link" href="{{route('get.jops.index')}}"><i class="side-menu__icon fa fa-wpforms"></i><span
                                        class="side-menu__label">المهام</span></a>
                            </li>
                            <li class="slide">
