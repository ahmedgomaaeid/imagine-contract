...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{route('index')}}/assets/logo.png" />
            ...
            <div class="">
                ...
                <div class="col col-login mx-auto mt-7">
                    <div class="text-center">
                        <img src="{{route('index')}}/assets/logo.png" class="header-brand-img" alt="" style="width:150px">
                    </div>
                </div>
