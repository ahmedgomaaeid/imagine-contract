                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">تعديل منزل 4 شعرات </h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            <form method="post" action="{{route('post.house4.edit',$house->id)}}" enctype= "multipart/form-data">
                            @csrf
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"> تعديل منزل 4 شعرات </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mb-4">
