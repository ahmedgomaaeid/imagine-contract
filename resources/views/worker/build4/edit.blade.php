                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">تعديل بناية 4 شعرات </h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            <form method="post" action="{{route('post.build4.edit',$house->id)}}" enctype= "multipart/form-data">
                            @csrf
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"> تعديل بناية 4 شعرات </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="tel" class="form-control" name="hook" placeholder="القراءة على الهوك " value="{{$house->hook}}">
                                                @error('hook')
                                                    <div class="invalid-feedback" style="display:block;">{{$message}}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="root_num" placeholder="رقم الروت" value="{{$house->root_num}}">
                                                @error('root_num')
                                                    <div class="invalid-feedback" style="display:block;">{{$message}}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="pre_spliter_signal" placeholder="اشارة ماقبل السبلتر " value="{{$house->pre_spliter_signal}}">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="port_signal_m" placeholder="اشارة المنافذ كمتوسط" value="{{$house->port_signal_m}}">
                                                @error('port_signal_m')
                                                    <div class="invalid-feedback" style="display:block;">{{$message}}</div>
                                                @enderror
