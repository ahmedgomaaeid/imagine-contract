                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">ادخال بناية 4 شعرات </h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            <form method="post" action="{{route('post.build4.create')}}" enctype= "multipart/form-data">
                            @csrf
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"> ادخال بناية 4 شعرات </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="pre_spliter_signal" placeholder="اشارة ماقبل السبلتر " value="{{old('pre_spliter_signal')}}">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="port_signal_m" placeholder="اشارة المنافذ كمتوسط" value="{{old('port_signal_m')}}">
                                                @error('port_signal_m')
                                                    <div class="invalid-feedback" style="display:block;">{{$message}}</div>
                                                @enderror
