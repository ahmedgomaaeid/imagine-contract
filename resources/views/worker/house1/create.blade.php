                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">ادخال منزل شعرة واحدة </h1>
                        </div>
                        <!-- PAGE-HEADER END -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            <form method="post" action="{{route('post.house1.create')}}" enctype= "multipart/form-data">
                            @csrf
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"> ادخال منزل شعرة واحدة </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mb-4">
